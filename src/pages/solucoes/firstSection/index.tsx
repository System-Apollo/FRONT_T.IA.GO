...
export default function FirstSection() {
    ...
    const features = [
        ...
        },
        {
            ...
            title: "Maior gerenciamento",
            desc: "Desenvolvida para otimizar o gerenciamento de processos jurídicos."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        },
        {
            ...
            title: "Mais automatização",
            desc: "Com um sistema centralizado e automatizado, sua equipe não precisa mais lidar com tarefas repetitivas e demoradas."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Mais conectividade",
            desc: "Capaz de conectar diretamente à nossa base de dados em Excel, sistemas operacionais via API e gerar gráficos."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: "Operação mais ágil, organizada e eficiente, com foco na estratégia em suas tomadas de decisões."
        },
    ]
        ...
        <section id='solucoes' ref={sectionRef} className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 text-center text-gray-600 md:px-8">
                ...
                >
                    ...
                    <p className="mt-3">
                        Uma solução de Inteligência Artificial Generativa, ideal para potencializar suas análises.
                    </p>
                </div>
                <div className="mt-12">
