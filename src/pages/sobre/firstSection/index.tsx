            ...
            <div className="max-w-screen-xl md:w-screen mx-auto md:px-8">
                <div className="items-center flex flex-col md:flex-row justify-around gap-x-12 sm:px-4 md:px-0 lg:flex">
                    ...
                    <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                        ...
                        <p className={`text-gray-800 text-3xl font-semibold sm:text-4xl transform transition-all duration-700 ease-in-out ${
                                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                            }`}>
                            Gerencie seus processos com mais agilidade, precisão e otimização
                        </p>
                        <p className={`mt-3 text-gray-600 transform transition-all duration-700 ease-in-out ${
                            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                        }`}>
                            Uma solução de Inteligência Artificial Generativa, desenvolvida para otimizar o gerenciamento de processos jurídicos.
                        </p>
                    </div>
                </div>
            </div>
